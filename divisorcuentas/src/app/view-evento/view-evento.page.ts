...
@Component({
  ...
  standalone: true,
  imports: [IonHeader, IonToolbar, IonButtons, IonBackButton, IonContent, IonItem, IonIcon, IonLabel, IonNote, IonButton, CommonModule, NgIf, NgFor,  FormsModule, RouterModule, ClpCurrencyPipe],
})
