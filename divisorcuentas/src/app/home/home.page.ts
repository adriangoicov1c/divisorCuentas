...
@Component({
  ...
  imports: [IonFabButton, IonHeader, IonToolbar, IonTitle, IonContent, EventoComponent, IonButton, IonFab, IonIcon, IonModal, IonFooter, IonInput, IonLabel, IonItem, FormsModule, CommonModule, IonButtons],
})
